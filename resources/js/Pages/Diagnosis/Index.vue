...
// DATA GEJALA KELUHAN (Termasuk 2 Kategori Tambahan)
const categories = ref([
    ...
    {
        name: 'Area Kemudi & Suspensi',
        symptoms: [
            { id: 'SYM-012', label: 'Setang terasa berat, kaku, atau melawan saat berbelok' },
            { id: 'SYM-013', label: 'Setang terasa goyang/bergetar saat jalan lurus atau direm' },
            { id: 'SYM-014', label: 'Suspensi depan terasa sangat keras atau sering bunyi jedug' },
            { id: 'SYM-015', label: 'Terdapat rembesan oli pada as shockbreaker depan' },
        ]
    },
    {
        name: 'Sistem Pendingin & Saringan',
        symptoms: [
            { id: 'SYM-016', label: 'Indikator suhu mesin (Temperature) menyala merah' },
            { id: 'SYM-017', label: 'Ada tetesan air radiator (hijau/merah) di bawah mesin' },
            { id: 'SYM-018', label: 'Tarikan mesin sangat berat dan bensin lebih boros dari biasanya' },
        ]
    }
]);
